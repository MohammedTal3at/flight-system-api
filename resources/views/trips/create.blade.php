...
@section('content')
	...
	<div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>From:</strong>
                {!! Form::select('from_place_id', $place_from,[], array('class' => 'form-control')) !!}
            </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>To:</strong>
                {!! Form::select('to_place_id', $place_to,[], array('class' => 'form-control')) !!}
            </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                {!! Form::number('economy', null, array('class' => 'form-control')) !!}
            </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                {!! Form::number('economyprice', null, array('class' => 'form-control')) !!}
            </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                {!! Form::number('standard', null, array('class' => 'form-control')) !!}
            </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                {!! Form::number('standardprice', null, array('class' => 'form-control')) !!}
            </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                {!! Form::number('firstclass', null, array('class' => 'form-control')) !!}
            </div>
        </div>
